...
def test_simplified_audiomae():
    """测试简化版AudioMAE模型"""
    print("Testing simplified AudioMAE...")
    ...
    try:
        # 创建简化版AudioMAE模型
        print("\nCreating simplified AudioMAE model...")
        ...
        print(f"Error in AudioMAE test: {e}")
        import traceback
...
if __name__ == "__main__":
    ...
    success = test_simplified_audiomae()
    
    print("\n" + "=" * 50)
    print("TEST SUMMARY")
    print("=" * 50)
    print(f"Simplified AudioMAE test: {'PASSED' if success else 'FAILED'}")
    print("=" * 50) 